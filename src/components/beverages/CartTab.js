...
const CartTab = () => {
  ...
  // ✅ If popup is open, only render the popup (hide rest of UI)
  if (showPopup) {
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white w-11/12 max-w-lg p-6 rounded-xl shadow-lg relative">
          ...
          <h3 className="text-xl font-bold text-[#28245F] mb-4 mt-2">Confirm Beverage Order</h3>
