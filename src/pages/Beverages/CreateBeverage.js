...
//     try {
//       await axios.post(`${API_URL}/beverages`, {
//         code, name, image, description, slug,
//         price, portionType, itemCategory, availableForMeals,
//       });
//       onSuccess('Beverage created.');
//       onClose();
//     } catch {
...
//             <input
//               id="portionType" placeholder="Portion Type"
//               className="w-full border rounded p-2"
//               value={portionType} onChange={e => setPortionType(e.target.value)}
//             />
//           </div>
//           <div>
//             <label htmlFor="itemCategory" className="block mb-1 text-sm font-medium">Category</label>
//             <input
//               id="itemCategory" placeholder="Category"
//               className="w-full border rounded p-2"
...
// export default function CreateBeverage(props) {
//   const { isOpen, onClose, onSuccess } = props;
//   const [code, setCode] = useState('');
//   const [name, setName] = useState('');
//   const [image, setImage] = useState('');
...
export default function CreateBeverage(props) {
  ...
  async function handleCreate() {
    ...
    try {
      ...
      onSuccess('Beverage created successfully.');
      onClose();
    } catch {
      setError('Create failed.');
    }
        ...
        <div className="bg-gray-50 px-6 py-4 rounded-t-xl border-b border-gray-200">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-lg font-semibold text-gray-900">Create New Beverage</h2>
            </div>
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                id="code"
                type="text"
                placeholder="Enter beverage code (e.g., B001)"
            ...
            <div className="mt-6 p-4 bg-orange-50 border border-orange-200 rounded-lg">
              <div className="flex items-center gap-2">
                ...
                <span className="text-orange-800 font-medium">
                  Price: ₹{price.toLocaleString()} per {portionType || 'serving'}
                </span>
              </div>
            </div>
          )}
