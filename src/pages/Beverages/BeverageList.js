      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white border rounded-lg p-8 shadow-sm">
          <div className="flex flex-col items-center gap-4">
            ...
            <span className="text-gray-600">Loading beverages...</span>
          </div>
        </div>
      </div>
    );
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Manage beverage menu items and pricing</p>
                </div>
              </div>
              ...
              <table className="min-w-full">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {currentItems.map((beverage) => (
                    <tr key={beverage.beverageId} className="hover:bg-gray-50 transition-colors">
                      <td className="py-4 px-4">
                        <div className="flex items-center">
                          <img
                            src={beverage.image || 'https://via.placeholder.com/40'}
                            alt={beverage.name}
                      ...
                      <td className="py-4 px-4 text-center">
                        <div className="flex items-center justify-center gap-2">
                          ...
                          <button
                            onClick={() => handleDelete(beverage.beverageId)}
          ...
          {currentItems.length === 0 && !loading && (
            <div className="bg-white border rounded-lg p-12 text-center mt-6">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No Beverages Found</h3>
              <p className="text-gray-500 mb-4">
                {searchTerm ? 'Try adjusting your search criteria.' : 'Get started by adding your first beverage item.'}
              </p>
              <button
                onClick={() => setShowCreate(true)}
          ...
          {bevs.length > 0 && (
            <div className="mt-6 bg-white border rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-medium text-gray-900 mb-4">Beverage Menu Summary</h3>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-sm text-blue-600">Total Beverages</p>
                      <p className="text-xl font-bold text-blue-900">{bevs.length}</p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-xl font-bold text-yellow-800">
                        ₹{(bevs.reduce((sum, item) => sum + item.price, 0) / bevs.length).toFixed(2)}
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-xl font-bold text-green-800">
                        ₹{Math.max(...bevs.map(item => item.price)).toFixed(2)}
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-xl font-bold text-orange-900">
                        {new Set(bevs.map(item => item.itemCategory)).size}
                      </p>
                    </div>
                  </div>
                </div>
