...
export default function CreateFood(props) {
  ...
  async function handleCreate() {
    ...
    try {
      ...
      onSuccess('Food item created successfully.');
      onClose();
    } catch {
      setError('Create failed.');
    }
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-xl shadow-xl w-full max-w-3xl border border-gray-200 max-h-[90vh] overflow-hidden">
        {/* Header */}
        <div className="bg-gray-50 px-6 py-4 rounded-t-xl border-b border-gray-200">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-lg font-semibold text-gray-900">Create New Food Item</h2>
            </div>
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                id="code"
                type="text"
                placeholder="Enter food code (e.g., F001)"
            ...
            <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <div className="flex items-center gap-2">
                ...
                <span className="text-yellow-800 font-medium">
                  Price: ₹{price.toLocaleString()} per {portionType || 'portion'}
                </span>
              </div>
            </div>
          )}
