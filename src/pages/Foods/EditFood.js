...
export default function EditFood(props) {
  ...
  async function handleUpdate() {
    ...
    try {
      ...
      onSuccess('Food item updated successfully.');
      onClose();
    } catch {
      setError('Update failed.');
    }
        ...
        <div className="bg-gray-50 px-6 py-4 rounded-t-xl border-b border-gray-200">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-lg font-semibold text-gray-900">Edit Food Item</h2>
            </div>
            <button
          ...
          <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-blue-600 rounded-lg flex items-center justify-center">
                <span className="text-white font-bold text-sm">#{initial.foodId}</span>
              </div>
              <div>
                <span className="text-sm text-blue-600 font-medium">Food ID</span>
                <p className="text-lg font-bold text-blue-900">#{initial.foodId}</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                onChange={e => setCode(e.target.value)}
              />
              <p className="mt-1 text-xs text-gray-500">Unique identifier for this food item</p>
            </div>
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">Selling price per portion</p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={e => setItemCategory(e.target.value)}
              />
              <p className="mt-1 text-xs text-gray-500">Food category or type</p>
            </div>
            ...
            <div>
              ...
              <input
                id="portionType"
                type="text"
                placeholder="e.g., Regular, Large, Family"
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors"
                value={portionType}
                onChange={e => setPortionType(e.target.value)}
              />
              <p className="mt-1 text-xs text-gray-500">Serving size or portion</p>
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <input
                ...
                onChange={e => setImage(e.target.value)}
              />
              <p className="mt-1 text-xs text-gray-500">URL of the food image for display</p>
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                onChange={e => setDescription(e.target.value)}
              />
              <p className="mt-1 text-xs text-gray-500">Brief description of the food item</p>
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <p className="mt-2 text-xs text-gray-500">Select which meals this item is available for</p>
            </div>
          </div>
          ...
          <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-sm text-yellow-600 font-medium">Price Change</p>
                  <div className="flex items-center gap-2">
                    <span className="text-sm text-yellow-800">₹{initial.price.toFixed(2)}</span>
                    <svg className="h-3 w-3 text-yellow-600" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd" />
                    </svg>
                    <span className="text-sm font-bold text-yellow-800">₹{price.toFixed(2)}</span>
                  </div>
                </div>
              </div>
              {price !== initial.price && (
