...
//     try {
//       await axios.put(
//         `http://localhost:8080/api/v1/InventoryItem/update/${initial.id}`,
//         {
//           itemCode,
//           itemName,
//           description,
...
//       await axios.put(
//         `http://localhost:8080/api/v1/InventoryItem/update/${initial.id}`,
//         { itemCode, itemName, description, slug, quantity, category, reOrderLevel, maximumReorderLevel }
//       );
//       onSuccess('Item updated.');
//       onClose();
//     } catch {
...
//           <div>
//             <label htmlFor="itemCode" className="block mb-1 text-sm font-medium">Item Code</label>
//             <input
//               id="itemCode" placeholder="Item Code"
//               className="w-full border rounded p-2"
//               value={itemCode} onChange={e => setItemCode(e.target.value)}
//             />
//           </div>
//           <div>
//             <label htmlFor="itemName" className="block mb-1 text-sm font-medium">Item Name</label>
//             <input
...
//           </div>
//           <div>
//             <label htmlFor="quantity" className="block mb-1 text-sm font-medium">Quantity</label>
//             <input
...
//           </div>
//           <div>
//             <label htmlFor="reOrderLevel" className="block mb-1 text-sm font-medium">Re-order Level</label>
//             <input
//               id="reOrderLevel" type="number" placeholder="Re-order Level"
//               className="w-full border rounded p-2"
//               value={reOrderLevel} onChange={e => setReOrderLevel(+e.target.value)}
//             />
//           </div>
//           <div>
//             <label htmlFor="maximumReorderLevel" className="block mb-1 text-sm font-medium">Max Re-order Level</label>
//             <input
//               id="maximumReorderLevel" type="number" placeholder="Max Re-order Level"
//               className="w-full border rounded p-2"
//               value={maximumReorderLevel} onChange={e => setMaximumReorderLevel(+e.target.value)}
//             />
//           </div>
//         </div>
//         <div className="mt-4 flex justify-end space-x-2">
