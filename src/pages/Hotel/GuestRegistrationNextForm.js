  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 p-6">
        <div className="backdrop-blur-xl bg-white/80 border border-white/40 shadow-2xl rounded-3xl overflow-hidden w-full max-w-4xl mx-auto"
          style={{
        ...
        >
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-8 py-6 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-blue-100 mt-1">Complete the guest information below</p>
            </div>
          </div>
          ...
          <div className="p-8">
            ...
            {isLoadingCustomer && (
              <div className="mb-6 p-4 backdrop-blur-md bg-blue-50/80 border border-blue-200/50 rounded-xl flex items-center shadow-sm">
                ...
                <span className="text-blue-700 font-medium">Loading customer information...</span>
              </div>
            )}
            ...
            {customerFound && !isLoadingCustomer && (
              <div className="mb-6 p-4 backdrop-blur-md bg-green-50/80 border border-green-200/50 rounded-xl flex items-center shadow-sm">
                ...
                <span className="text-green-700 font-medium">Existing customer found! Form has been pre-filled with saved information.</span>
              </div>
            )}
            ...
            {!customerFound && !isLoadingCustomer && nicPassportPf && (
              <div className="mb-6 p-4 backdrop-blur-md bg-gray-50/80 border border-gray-200/50 rounded-xl flex items-center shadow-sm">
                ...
                <span className="text-gray-700 font-medium">New customer - please fill in all required information.</span>
              </div>
            )}
            ...
            {customerLoadError && (
              <div className="mb-6 p-4 backdrop-blur-md bg-orange-50/80 border border-orange-200/50 rounded-xl flex items-center shadow-sm">
                ...
                <span className="text-orange-700 font-medium">{customerLoadError}</span>
              </div>
            )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="group">
                <label htmlFor="nameWithInitials" className="block text-sm font-medium text-gray-700 mb-2">Name with Initials</label>
                <div className="relative">
                  <input
                    id="nameWithInitials"
                    name="nameWithInitials"
              ...
              <div className="col-span-2 group">
                <label htmlFor="nameInFull" className="block text-sm font-medium text-gray-700 mb-2">Full Name</label>
                <div className="relative">
                  <input
                    id="nameInFull"
                    name="nameInFull"
              ...
              {/* ID & Nationality */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">NIC / Passport / PIF</label>
                <input
                  value={nicPassportPf}
                  disabled
              ...
              <div className="group">
                <label className="block text-sm font-medium text-gray-700 mb-2">Office Telephone</label>
                <div className="relative">
                  <input
                    name="officeTel"
                    value={form.officeTel}
              ...
              <div className="group">
                <label className="block text-sm font-medium text-gray-700 mb-2">Bill No(s)</label>
                <div className="relative">
                  <input
                    name="billNos"
                    value={form.billNos}
              ...
              {/* Payment & Vehicle */}
              <div className="group">
                <label htmlFor="modeOfPayment" className="block text-sm font-medium text-gray-700 mb-2">Mode of Payment</label>
                <div className="relative">
                  <select
                    id="modeOfPayment"
                    name="modeOfPayment"
              ...
              <div className="group">
                <label className="block text-sm font-medium text-gray-700 mb-2">Vehicle No(s)</label>
                <div className="relative">
                  <input
                    name="vehicleNos"
                    value={form.vehicleNos}
            ...
            <div className="flex flex-col sm:flex-row justify-between gap-4 mt-8">
              ...
              >
                <svg className="h-5 w-5 transition-transform duration-300 group-hover:-translate-x-1" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M9.707 14.707a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 1.414L7.414 9H15a1 1 0 110 2H7.414l2.293 2.293a1 1 0 010 1.414z" clipRule="evenodd" />
                </svg>
                Back
              </button>
      ...
      {showConfirmModal && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="backdrop-blur-xl bg-white/90 border border-white/40 rounded-2xl p-6 max-w-md w-full shadow-2xl"
            style={{
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="backdrop-blur-xl bg-white/90 border border-white/40 rounded-2xl p-6 max-w-md w-full shadow-2xl text-center"
            style={{
              boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.25), 0 0 0 1px rgba(255, 255, 255, 0.3)'
            }}
          >
