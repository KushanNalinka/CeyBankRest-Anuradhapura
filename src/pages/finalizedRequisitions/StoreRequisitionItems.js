...
//               <th className="p-2 border">💵 Total</th>
//               <th className="p-2 border">🆔 GRN No</th>
//               <th className="p-2 border">🗓️ Received Date</th>
//             </tr>
//           </thead>
//           <tbody>
...
const StoreRequisitionItems = () => {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .catch(() => setMessage('Failed to load store requisition items.'))
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white border rounded-lg p-8 shadow-sm">
          <div className="flex flex-col items-center gap-4">
            ...
            <span className="text-gray-600">Loading store requisition items...</span>
          </div>
        </div>
      </div>
    );
          ...
          <div className="mb-6 bg-white border rounded-lg p-6 shadow-sm">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gray-900">Store Requisition Items</h1>
                  <p className="text-gray-600">Store Requisition ID: #{id}</p>
                </div>
              </div>
              ...
              <table className="min-w-full">
                ...
                <thead className="bg-blue-600">
                  <tr>
                    ...
                    <th className="py-3 px-4 text-center text-white font-medium text-xs">Received</th>
                    ...
                    <th className="py-3 px-4 text-center text-white font-medium text-xs">GRN No</th>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {currentItems.map((item) => (
                    <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="py-3 px-4 text-center">
                        <span className="text-gray-700 text-sm font-mono bg-gray-100 px-2 py-1 rounded">
                          {item.grnNo || 'N/A'}
                        </span>
                      </td>
                      <td className="py-3 px-4 text-center">
            ...
            {currentItems.length === 0 && !loading && (
              <div className="p-12 text-center">
                ...
                <p className="text-gray-500">
                  {searchTerm ? 'Try adjusting your search criteria.' : 'No items found for this store requisition.'}
                </p>
              </div>
            )}
