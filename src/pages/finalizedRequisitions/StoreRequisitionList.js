...
const StoreRequisitionList = () => {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .catch(() => setMessage('Failed to load store requisitions.'))
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white border rounded-lg p-8 shadow-sm">
          <div className="flex flex-col items-center gap-4">
            ...
            <span className="text-gray-600">Loading store requisitions...</span>
          </div>
        </div>
      </div>
    );
          ...
          <div className="bg-white border rounded-lg overflow-hidden shadow-sm">
            ...
            {currentRequisitions.length === 0 && !loading && (
              <div className="p-12 text-center">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">No Store Requisitions Found</h3>
                <p className="text-gray-500">
                  {searchTerm ? 'Try adjusting your search criteria.' : 'No store requisitions have been created yet.'}
                </p>
              </div>
            )}
